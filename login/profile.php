...
<body>
    ...
    <div id="container">
        ...
        <div id="imgh">
            ...
            <div id="nn">
                <a href="profile.php?id=<?php echo $user_data['url_address'] ?>" style="text-decoration:none"><?php echo $user_data['first_name'] . " " . $user_data['last_name']; ?>
                    <br>
            ...
            if ($user_data['userid'] == $_SESSION['SOCIAL_userid']) : ?>
                ...
                <a href="messages.php">
                    ...
                    <input type="submit" id="post_btn" value="Messages" style="margin-top:32px; margin-right:10px;  background-color:#1b9186;">


                </a>
            <?php else : ?>

                <a href="messages.php?type=new&id=<?php echo $user_data['userid']; ?>">


                    <input type="submit" id="post_btn" value="Message" style="margin-top:32px; margin-right:10px;  background-color:#1b9186;">
            ...
            <div id="menus"><a href='profile.php?section=about&id=<?php echo $user_data['userid'] ?>'>About</a></div>
            <div id="menus"><a href='profile.php?section=followers&id=<?php echo $user_data['userid'] ?>'>Followers</a></div>
            <div id="menus"><a href='profile.php?section=following&id=<?php echo $user_data['userid'] ?>'>Following</a></div>
