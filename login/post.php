<div id="posts">
    ...
    <div style="width:100%">
        ...
        echo check_tags($row['post']); //treates special character 

        ?>

        <?php //echo check_admin_tags($row['post']); //treates special character 
        ?>
        ...
        if (file_exists($row['image'])) {
            ...
            echo '
            <a href="single_post.php?id=' . $row['userid'] . '">';
        ...
        <span style="float:right">
            ...
            if (isset($_GET['status']) and $_GET['status'] == "Admin") {

                $status = $_GET['status'];
                //echo $_GET['id'];
                echo "
                <a href='edit.php?status=$status&id=$row[userid]'>
                    Edit
                </a>.
                <a href='delete.php?type=del&id=$row[userid]&status=$status'>
                    Delete
                </a>";
            } elseif ($post->owned_post($row['userid'], $_SESSION['SOCIAL_userid'])) {
                ...
                <a href='delete.php?type=del&id=$row[userid]'>
                    Delete
                </a>";
            } else {
                echo "";
